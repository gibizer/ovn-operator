...
func (r *OVNNorthdReconciler) Reconcile(ctx context.Context, req ctrl.Request) (result ctrl.Result, _err error) {
	...
	defer func() {
		...
		Log.Info("!!! before defer PatchInstance", "instance.Status.ObservedGeneration", instance.Status.ObservedGeneration)
		err := helper.PatchInstance(ctx, instance)
		if err != nil {
			_err = err
			Log.Info("!!! patch failed", "err", err)
			return
		}
	}()
	...
	if instance.DeletionTimestamp.IsZero() && controllerutil.AddFinalizer(instance, helper.GetFinalizer()) {
		Log.Info("!!! returning as added finalizer")
		return ctrl.Result{}, nil
	}
	...
	Log.Info("!!! observed generation is set", "instance.Status.ObservedGeneration", instance.Status.ObservedGeneration)
